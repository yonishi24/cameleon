 ...
 * file, You can obtain one at https://mozilla.org/MPL/2.0/. */
 ...
 pub(super) const MODEL_NAME: &str = "CameleonGenTLGEVInterfaceModule";
 pub(super) const VENDOR_NAME: &str = "CameleonProjectDevelopers";
 pub(super) const TOOL_TIP: &str = "GenTL GEV Interface Module";
 ...
 const PRODUCT_GUID: &str = "9BAEECEB-59DC-4AAD-B75F-D7BFB669F486";
 const VERSION_GUID: &str = "AF7B7BCC-5A33-45C1-AE34-DE8EC979C3AD";
