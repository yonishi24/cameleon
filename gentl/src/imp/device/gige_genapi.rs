 ...
 * file, You can obtain one at https://mozilla.org/MPL/2.0/. */
 ...
 use GenApiReg::{
     DeviceAccessStatus, DeviceID, DeviceModelName, DeviceVendorName, StreamID, StreamSelector,
     StreamSelectorMax,
 };
 
 use crate::imp::{
     genapi_common::{SCHEME_MAJOR_VERSION, SCHEME_MINOR_VERSION, SCHEME_SUBMINOR_VERSION},
     port,
 };
 ...
 pub(super) const MODEL_NAME: &str = "CameleonGenTLGEVDeviceModule";
 pub(super) const VENDOR_NAME: &str = "CameleonProjectDevelopers";
 pub(super) const TOOL_TIP: &str = "GenTL GEV Device Module";
 
 pub(super) const DEVICE_TYPE: port::TlType = port::TlType::USB3Vision;
 pub(super) const PORT_NAME: &str = "DevicePort";
 
 const PRODUCT_GUID: &str = "95E57E6A-40F4-4682-A82C-8FAAC144ACBF";
 const VERSION_GUID: &str = "422313CE-B105-487C-8288-DB808A072D36";
