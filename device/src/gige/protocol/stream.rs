...
//! This module provides parser for GEV stream protocol.
use std::{
...
/// # Example
/// ```no_run
/// use cameleon_device::gev::protocol::stream::{Leader, PayloadType, ImageLeader,
///                                             ImageExtendedChunkLeader, ChunkLeader};
///
/// // Buffer for leader bytes.
/// let mut buf = Vec::new();
///
/// // Fill buffer using [`cameleon_device::gev::Device`].
/// // ..
///
...
impl ImageTrailer {
    ...
    ///
    /// Some GEV cameras support variable frame size, in that case, the height of the image may
